...
import { subjectsSchema } from "./schemma.validate";
import { toast } from "sonner";

export type SubjectsFormData = z.infer<typeof subjectsSchema>;

export function ReusableSubjectsForm() {
  const methods = useForm<SubjectsFormData>({
  ...
  const handleFormSubmit = (data: SubjectsFormData) => {
    const formattedData = {
    ...
    toast.success('New subjects created');
  };
